document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadData() {
        ...
        fetch(`5.158.217.98:5000/apiCobertura/catastral?minx=${minx}&miny=${miny}&maxx=${maxx}&maxy=${maxy}`)
            .then(response => {
                if (!response.ok) {
    ...
    window.updateCobertura = function (NINTERNO, cobertura) {
        ...
        fetch(`5.158.217.98:5000/apiCobertura/update_cobertura/${NINTERNO}`, {
            method: 'POST',
            headers: {
    ...
    window.searchAddress = function () {
        ...
        fetch(`5.158.217.98:5000/apiCobertura/search_address?query=${encodeURIComponent(query)}&option=2`)
            .then(response => {
                if (!response.ok) {
    ...
    window.showSuggestions = function (query) {
        ...
        fetch(`5.158.217.98:5000/apiCobertura/search_address?query=${encodeURIComponent(query)}&option=1`)
